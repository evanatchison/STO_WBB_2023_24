...
shooting_by_quarter2 <- shooting_by_quarter %>%
  filter(checkname52 != "johnson,kylie", checkname52 != "tangen,sarah", checkname52 != "howdeshell,sarah")
...
quarterly_shooting("zhen")

#strong first quarter scorers: hegland, kelly, kormann
#strong second quarter scorers: hegland, olmen, yagodinski
#strong third quarter scorers: hegland
#strong fourth quarter scorers: fix, hegland, kelly, yagodinski
