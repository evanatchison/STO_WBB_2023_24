...
```{r Game by Game Data}
clean_lineups("11_11_Alma_Lineups", "11/11/2022", "Alma College") %>% 
...
```{r Testing for Errors}
### Testing for erros
#   new_tibble <- read_excel(str_c("data/", "11_16_Minnesota_Morris", ".xlsx"), 
#                            col_types = c("text", "text", "text", "text", "text", "text", "text", "text", "text", "text")
#   )
#   new_data <- new_tibble%>%
#     rename(Lineup = 1,
...
#   new_data
#   
# new_tibble <- read_excel(str_c("data/", "11_11_Alma_Lineups", ".xlsx"), col_types = c("text", "text", "guess", "guess", "guess", "guess", "guess", "guess", "guess", "guess"))
