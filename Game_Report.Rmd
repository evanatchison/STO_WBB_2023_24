---
title: "St. Olaf WBB 2022-23 Game Report"
...
lineups %>%
  ...
  rename(Date = date,
         Opponent = opp) %>%
  gt() %>%
  tab_header(title = "All Games Included in this Report")
```


#### [Link to MIAC Only Game Statistics](https://matous1.github.io/STO_WBB_2022_23/MIAC_Game_Report.html) 
...
# **Individual Summary Statistics - All Games**
...
# **Lineup Reports - All Games** {.tabset .tabset-fade .tabset-pills}
